...
function dumpNode(bookmarkNode, query) {
  if (bookmarkNode.title) {
    ...
    var options = bookmarkNode.children ?
      ...
      $('<span>[<a id="starlink" href="#">Star</a> <a id="deletelink" ' +
        'href="#">Delete</a>]</span>');
    ...
    // Show add and edit links when hover over.
        ...
        $('#starlink').click(function () {
          ...
          window.localStorage.setItem('StarBookmarks', JSON.stringify(starBookmarks));
        });
        options.fadeIn();
      },
      // unhover
...
document.addEventListener('DOMContentLoaded', function () {
  starBookmarks = window.localStorage.getItem('StarBookmarks');
  if(starBookmarks) {
